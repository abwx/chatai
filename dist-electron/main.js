import gn, { app as Qe, BrowserWindow as Lo, protocol as Ng, net as Dg, dialog as is, ipcMain as Pt, Menu as ac } from "electron";
import ye from "fs";
...
var He = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Rt = {}, wn = {}, We = {};
...
var Lt = Fg, Mg = process.cwd, Gi = null, Bg = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
function Hg(t) {
  ...
  function e(c) {
    c.lchmod = function(u, h, p) {
      ...
      var p = c.openSync(u, Lt.O_WRONLY | Lt.O_SYMLINK, h), y = !0, _;
      try {
  ...
  function n(c) {
    Lt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, h, p, y) {
      c.open(u, Lt.O_SYMLINK, function(_, E) {
        if (_) {
          y && y(_);
          return;
        }
      ...
      var y = c.openSync(u, Lt.O_SYMLINK), _, E = !0;
      try {
...
var fe = ye, Yg = jg, Xg = qg, Kg = Wg, Ei = ko, xe, as;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (xe = Symbol.for("graceful-fs.queue"), as = Symbol.for("graceful-fs.previous")) : (xe = "___graceful-fs.queue", as = "___graceful-fs.previous");
function Jg() {
}
function Lf(t, e) {
...
var pn = Jg;
Ei.debuglog ? pn = Ei.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (pn = function() {
...
if (!fe[xe]) {
  ...
  Lf(fe, Qg), fe.close = function(t) {
    ...
    return Object.defineProperty(e, as, {
      value: t
    }), e;
    ...
    pn(fe[xe]), xf.equal(fe[xe].length, 0);
  });
}
He[xe] || Lf(He, fe[xe]);
var Ve = Uo(Kg(fe));
...
function Uo(t) {
  ...
  function n(w, j, L) {
    ...
    function W(re, N, $, F) {
      return e(re, N, function(I) {
        I && (I.code === "EMFILE" || I.code === "ENFILE") ? Sn([W, [re, N, $], I, F || Date.now(), Date.now()]) : typeof $ == "function" && $.apply(this, arguments);
      });
    }
  }
  var r = t.writeFile;
  ...
  function i(w, j, L, W) {
    ...
    function re(N, $, F, I, k) {
      return r(N, $, F, function(D) {
        D && (D.code === "EMFILE" || D.code === "ENFILE") ? Sn([re, [N, $, F, I], D, k || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var s = t.appendFile;
  ...
  function u(w, j, L) {
    ...
    function re(N, $, F, I) {
      return function(k, D) {
        k && (k.code === "EMFILE" || k.code === "ENFILE") ? Sn([
          W,
          [N, $, F],
          k,
          I || Date.now(),
...
function Sn(t) {
  pn("ENQUEUE", t[0].name, t[1]), fe[xe].push(t), Mo();
}
var vi;
function cc() {
...
function Mo() {
  if (clearTimeout(vi), vi = void 0, fe[xe].length !== 0) {
    ...
    if (i === void 0)
      pn("RETRY", e.name, n), e.apply(null, n);
      ...
      o >= f ? (pn("RETRY", e.name, n), e.apply(null, n.concat([i]))) : fe[xe].push(t);
    }
...
const Uf = wn, { checkPath: Mf } = kf, Bf = (t) => {
  const e = { mode: 511 };
...
const e_ = We.fromPromise, { makeDir: t_, makeDirSync: ga } = Bo, _a = e_(t_);
var At = {
  mkdirs: _a,
  mkdirsSync: ga,
  // alias
...
function s_(t, e, n) {
  const r = Hn.openSync(t, "r+");
  return Hn.futimesSync(r, e, n), Hn.closeSync(r);
}
var Hf = {
  utimesMillis: i_,
  utimesMillisSync: s_
};
const Gn = wn, Re = he, a_ = ko;
function o_(t, e, n) {
  const r = n.dereference ? (i) => Gn.stat(i, { bigint: !0 }) : (i) => Gn.lstat(i, { bigint: !0 });
  return Promise.all([
    r(t),
    r(e).catch((i) => {
...
function l_(t, e, n) {
  let r;
  const i = n.dereference ? (a) => Gn.statSync(a, { bigint: !0 }) : (a) => Gn.lstatSync(a, { bigint: !0 }), s = i(t);
  try {
    r = i(e);
  } catch (a) {
...
function c_(t, e, n, r, i) {
  a_.callbackify(o_)(t, e, r, (s, a) => {
    ...
    return o.isDirectory() && jo(t, e) ? i(new Error(Os(t, e, n))) : i(null, { srcStat: o, destStat: l });
  });
}
function u_(t, e, n, r) {
...
function qf(t, e, n, r, i) {
  ...
  Gn.stat(a, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : Kr(e, l) ? i(new Error(Os(t, n, r))) : qf(t, e, a, r, i));
}
function Gf(t, e, n, r) {
  ...
  let a;
  try {
    a = Gn.statSync(s, { bigint: !0 });
  } catch (o) {
    if (o.code === "ENOENT") return;
    throw o;
  }
  if (Kr(e, a))
    throw new Error(Os(t, n, r));
  return Gf(t, e, s, r);
}
function Kr(t, e) {
...
const Ke = Ve, $r = he, f_ = At.mkdirs, d_ = En.pathExists, h_ = Hf.utimesMillis, Pr = Xn;
function p_(t, e, n, r) {
...
function uc(t, e, n, r, i) {
  ...
  d_(s, (a, o) => {
    if (a) return i(a);
    if (o) return os(t, e, n, r, i);
    f_(s, (l) => l ? i(l) : os(t, e, n, r, i));
  });
}
...
function m_(t, e, n, r, i) {
  return r.filter ? Wf(os, t, e, n, r, i) : os(t, e, n, r, i);
}
...
function Vf(t, e, n, r, i) {
  Ke.copyFile(e, n, (s) => s ? i(s) : r.preserveTimestamps ? y_(t.mode, e, n, i) : $s(n, t.mode, i));
}
function y_(t, e, n, r) {
...
var R_ = p_;
const ke = Ve, xr = he, I_ = At.mkdirsSync, O_ = Hf.utimesMillisSync, Nr = Xn;
function $_(t, e, n) {
...
var Y_ = Go;
Go.sync = ed;
const ls = Ve, X_ = We.fromCallback, td = Y_;
function K_(t, e) {
  if (ls.rm) return ls.rm(t, { recursive: !0, force: !0 }, e);
  td(t, e);
}
function J_(t) {
  if (ls.rmSync) return ls.rmSync(t, { recursive: !0, force: !0 });
  td.sync(t);
}
var Ps = {
  remove: X_(K_),
...
const Q_ = We.fromPromise, nd = wn, rd = he, id = At, sd = Ps, gc = Q_(async function(e) {
  let n;
  try {
...
const e0 = We.fromCallback, ad = he, jt = Ve, od = At;
function t0(t, e) {
  function n() {
    jt.writeFile(t, "", (r) => {
      if (r) return e(r);
  ...
  jt.stat(t, (r, i) => {
    ...
    jt.stat(s, (a, o) => {
      ...
      o.isDirectory() ? n() : jt.readdir(s, (l) => {
        if (l) return e(l);
      });
    });
  });
...
const i0 = We.fromCallback, ld = he, Bt = Ve, cd = At, s0 = En.pathExists, { areIdentical: ud } = Xn;
function a0(t, e, n) {
  function r(i, s) {
    Bt.link(i, s, (a) => {
      if (a) return n(a);
...
function o0(t, e) {
  ...
  try {
    const s = Bt.lstatSync(t);
    if (n && ud(s, n)) return;
  } catch (s) {
    throw s.message = s.message.replace("lstat", "ensureLink"), s;
  }
  const r = ld.dirname(e);
  return Bt.existsSync(r) || cd.mkdirsSync(r), Bt.linkSync(t, e);
}
var l0 = {
  createLink: i0(a0),
  createLinkSync: o0
};
const Ht = he, Ar = Ve, c0 = En.pathExists;
function u0(t, e, n) {
  if (Ht.isAbsolute(t))
...
const g0 = We.fromCallback, dd = he, ft = wn, hd = At, _0 = hd.mkdirs, y0 = hd.mkdirsSync, pd = d0, w0 = pd.symlinkPaths, E0 = pd.symlinkPathsSync, md = m0, v0 = md.symlinkType, b0 = md.symlinkTypeSync, A0 = En.pathExists, { areIdentical: gd } = Xn;
function S0(t, e, n, r) {
...
const xs = We, { stringify: _d, stripBom: yd } = Wo;
async function $0(t, e = {}) {
  typeof e == "string" && (e = { encoding: e });
  const n = e.fs || Wn, r = "throws" in e ? e.throws : !0;
  let i = await xs.fromCallback(n.readFile)(t, e);
  i = yd(i);
  let s;
  try {
...
async function N0(t, e, n = {}) {
  const r = n.fs || Wn, i = _d(e, n);
  await xs.fromCallback(r.writeFile)(t, i, n);
}
const D0 = xs.fromPromise(N0);
function F0(t, e, n = {}) {
  const r = n.fs || Wn, i = _d(e, n);
...
const U0 = We.fromCallback, Sr = Ve, wd = he, Ed = At, M0 = En.pathExists;
function B0(t, e, n, r) {
...
var J0 = Ge;
const Q0 = Ve, io = he, Z0 = qo.copy, vd = Ps.remove, ey = At.mkdirp, ty = En.pathExists, Cc = Xn;
function ny(t, e, n, r) {
  ...
  Cc.checkPaths(t, e, "move", n, (s, a) => {
    ...
    Cc.checkParentPaths(t, o, e, "move", (f) => {
      ...
      ey(io.dirname(e), (c) => c ? r(c) : Tc(t, e, i, l, r));
    });
  });
}
function ry(t) {
...
function Tc(t, e, n, r, i) {
  if (r) return ya(t, e, n, i);
  if (n)
    return vd(e, (s) => s ? i(s) : ya(t, e, n, i));
  ty(e, (s, a) => s ? i(s) : a ? i(new Error("dest already exists.")) : ya(t, e, n, i));
}
function ya(t, e, n, r) {
...
var sy = ny;
const bd = Ve, so = he, ay = qo.copySync, Ad = Ps.removeSync, oy = At.mkdirpSync, Rc = Xn;
function ly(t, e, n) {
  n = n || {};
  const r = n.overwrite || n.clobber || !1, { srcStat: i, isChangingCase: s = !1 } = Rc.checkPathsSync(t, e, "move", n);
  return Rc.checkParentPathsSync(t, i, e, "move"), cy(e) || oy(so.dirname(e)), uy(t, e, r, s);
}
function cy(t) {
  const e = so.dirname(t);
  return so.parse(e).root === e;
}
function uy(t, e, n, r) {
  if (r) return wa(t, e, n);
  if (n)
    return Ad(e), wa(t, e, n);
...
Wt.CancellationToken = gy;
class ao extends Error {
  constructor() {
    super("cancelled");
  }
}
Wt.CancellationError = ao;
var Kn = {};
...
var qe = {}, oo = { exports: {} }, Ai = { exports: {} }, Ea, Ic;
function yy() {
  if (Ic) return Ea;
  Ic = 1;
...
var Si = { exports: {} }, ba, Pc;
function Ey() {
  return Pc || (Pc = 1, ba = (t, e = process.argv) => {
...
function vy() {
  if (xc) return Aa;
  xc = 1;
  const t = Is, e = Df, n = Ey(), { env: r } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? oo.exports = wy() : oo.exports = by();
var Ay = oo.exports, Jr = {};
...
qe.createHttpError = co;
qe.parseJson = Ny;
qe.configureRequestOptionsFromUrl = Td;
qe.configureRequestUrl = Yo;
qe.safeGetHeader = qn;
qe.configureRequestOptions = cs;
qe.safeStringifyJson = us;
const Ty = yn, Ry = Ay, Iy = ye, Oy = Xr, lo = Xt, $y = Wt, Dc = Kn, Py = Jr, rn = (0, Ry.default)("electron-builder");
function co(t, e = null) {
  return new zo(t.statusCode || -1, `${t.statusCode} ${t.statusMessage}` + (e == null ? "" : `
` + JSON.stringify(e, null, "  ")) + `
Headers: ` + us(t.headers), e);
}
...
class Ln {
  ...
  doApiRequest(e, n, r, i = 0) {
    return rn.enabled && rn(`Request: ${us(e)}`), n.createPromise((s, a, o) => {
  ...
  handleResponse(e, n, r, i, s, a, o) {
    var l;
    if (rn.enabled && rn(`Response: ${e.statusCode} ${e.statusMessage}, request options: ${us(n)}`), e.statusCode === 404) {
      s(co(e, `method: ${n.method || "GET"} url: ${n.protocol || "https:"}//${n.hostname}${n.port ? `:${n.port}` : ""}${n.path}
...
`));
    ...
    const f = (l = e.statusCode) !== null && l !== void 0 ? l : 0, c = f >= 300 && f < 400, u = qn(e, "location");
    if (c && u != null) {
      if (a > this.maxRedirects) {
        s(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(Ln.prepareRedirectUrlOptions(u, n), r, o, a).then(i).catch(s);
      return;
    }
    e.setEncoding("utf8");
    let h = "";
    e.on("error", s), e.on("data", (p) => h += p), e.on("end", () => {
      try {
        if (e.statusCode != null && e.statusCode >= 400) {
          const p = qn(e, "content-type"), y = p != null && (Array.isArray(p) ? p.find((_) => _.includes("json")) != null : p.includes("json"));
          s(co(e, `method: ${n.method || "GET"} url: ${n.protocol || "https:"}//${n.hostname}${n.port ? `:${n.port}` : ""}${n.path}
  ...
  doDownload(e, n, r) {
    const i = this.createRequest(e, (s) => {
      ...
      const a = qn(s, "location");
      if (a != null) {
        r < this.maxRedirects ? this.doDownload(Ln.prepareRedirectUrlOptions(a, e), n, r++) : n.callback(this.createMaxRedirectError());
        return;
      }
  ...
  static prepareRedirectUrlOptions(e, n) {
    ...
    if (i != null && i.authorization) {
      const s = Ln.reconstructOriginalUrl(n), a = Cd(e, n);
      Ln.isCrossOriginRedirect(s, a) && (rn.enabled && rn(`Given the cross-origin redirect (from ${s.host} to ${a.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return r;
  }
...
function Fy(t, e) {
  if (!Dy(qn(e, "X-Checksum-Sha2"), t.options.sha2, t.callback))
    return;
  const n = [];
  if (t.options.onProgress != null) {
    const a = qn(e, "content-length");
  ...
  r != null ? n.push(new uo(r, "sha512", r.length === 128 && !r.includes("+") && !r.includes("Z") && !r.includes("=") ? "hex" : "base64")) : t.options.sha2 != null && n.push(new uo(t.options.sha2, "sha256", "hex"));
...
const $d = yn, Pd = Kn, Gy = "options.name must be either a string or a Buffer", Fc = (0, $d.randomBytes)(16);
Fc[0] = Fc[0] | 1;
const zi = {}, te = [];
for (let t = 0; t < 256; t++) {
...
Vn.UUID = _n;
_n.OID = _n.parse("6ba7b812-9dad-11d1-80b4-00c04fd430c8");
function Lc(t) {
  switch (t) {
    case 0:
    case 1:
...
function Wy(t, e, n, r, i = Cr.ASCII) {
  ...
  switch (i) {
    case Cr.BINARY:
      ...
      break;
    case Cr.OBJECT:
      o[6] = o[6] & 15 | n, o[8] = o[8] & 63 | 128, l = new _n(o);
      break;
    default:
...
Vn.nil = new _n("00000000-0000-0000-0000-000000000000");
var Zr = {}, xd = {};
(function(t) {
  (function(e) {
...
Actual: ` + m.attribValue
    ...
    function ee(m, d) {
      if (m.opt.xmlns) {
        ...
        for (var le = 0, pe = m.attribList.length; le < pe; le++) {
          var Ie = m.attribList[le], Fe = Ie[0], xt = Ie[1], Ee = D(Fe, !0), at = Ee.prefix, la = Ee.local, ui = at === "" ? "" : R.ns[at] || "", nr = {
            name: Fe,
            value: xt,
            prefix: at,
            local: la,
          ...
          ), nr.uri = at), m.tag.attributes[Fe] = nr, W(m, "onattribute", nr);
        }
    ...
    function Q(m) {
      ...
      for (var le = m.tags.length; le-- > d; ) {
        ...
        for (var Fe in pe.ns)
          Ie[Fe] = pe.ns[Fe];
        var xt = m.tags[m.tags.length - 1] || m;
        m.opt.xmlns && pe.ns !== xt.ns && Object.keys(pe.ns).forEach(function(Ee) {
          var at = pe.ns[Ee];
    ...
    String.fromCodePoint || function() {
      var m = String.fromCharCode, d = Math.floor, R = function() {
        ...
        for (var xt = ""; ++Ie < Fe; ) {
          ...
          Ee <= 65535 ? ne.push(Ee) : (Ee -= 65536, le = (Ee >> 10) + 55296, pe = Ee % 1024 + 56320, ne.push(le, pe)), (Ie + 1 === Fe || ne.length > b) && (xt += m.apply(null, ne), ne.length = 0);
        }
        return xt;
      };
...
function nw(t, e) {
  ...
  for (l = 1; l <= e.linesBefore && !(a - l < 0); l++)
    f = Sa(
      ...
      u
    ), o = dr.repeat(" ", e.indent) + Ca((t.line - l + 1).toString(), c) + " | " + f.str + `
` + o;
  for (f = Sa(t.buffer, r[a], i[a], t.position, u), o += dr.repeat(" ", e.indent) + Ca((t.line + 1).toString(), c) + " | " + f.str + `
...
fo.prototype.extend = function(e) {
  var n = [], r = [];
  if (e instanceof Ta)
    r.push(e);
  ...
  n.forEach(function(s) {
    if (!(s instanceof Ta))
      throw new or("Specified list of YAML types (or a single Type object) contains a non-Type object.");
    ...
    if (s.multi)
      throw new or("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.");
...
var Ld = fo, cw = ze, kd = new cw("tag:yaml.org,2002:str", {
  kind: "scalar",
...
}), ln = dt, nh = ei, aE = rw, oE = Zo, Vt = Object.prototype.hasOwnProperty, fs = 1, rh = 2, ih = 3, ds = 4, Ra = 1, lE = 2, Bc = 3, cE = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, uE = /[\x85\u2028\u2029]/, fE = /[,\[\]\{\}]/, sh = /^(?:!|!!|![a-z\-]+!)$/i, ah = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function jc(t) {
...
var qc = {
  YAML: function(e, n, r) {
    var i, s, a;
    e.version !== null && q(e, "duplication of %YAML directive"), r.length !== 1 && q(e, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(r[0]), i === null && q(e, "ill-formed argument of the YAML directive"), s = parseInt(i[1], 10), a = parseInt(i[2], 10), s !== 1 && q(e, "unacceptable YAML version of the document"), e.version = r[0], e.checkLineBreaks = a < 2, a !== 1 && a !== 2 && hs(e, "unsupported YAML version of the document");
  },
  TAG: function(e, n, r) {
    var i, s;
    r.length !== 2 && q(e, "TAG directive accepts exactly two arguments"), i = r[0], s = r[1], sh.test(i) || q(e, "ill-formed tag handle (first argument) of the TAG directive"), Vt.call(e.tagMap, i) && q(e, 'there is a previously declared suffix for "' + i + '" tag handle'), ah.test(s) || q(e, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Gc(t, e, n, r) {
  var i, s, a, o;
  for (ln.isObject(n) || q(t, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(n), a = 0, o = i.length; a < o; a += 1)
    s = i[a], Vt.call(e, s) || (oh(e, s, n[s]), r[s] = !0);
}
function Un(t, e, n, r, i, s, a, o, l) {
  var f, c;
  if (Array.isArray(i))
  ...
  if (typeof i == "object" && jc(i) === "[object Object]" && (i = "[object Object]"), i = String(i), e === null && (e = {}), r === "tag:yaml.org,2002:merge")
    ...
    !t.json && !Vt.call(n, i) && Vt.call(e, i) && (t.line = a || t.line, t.lineStart = o || t.lineStart, t.position = l || t.position, q(t, "duplicated mapping key")), oh(e, i, s), delete n[i];
  return e;
}
function el(t) {
  var e;
...
function _e(t, e, n) {
  ...
  return n !== -1 && r !== 0 && t.lineIndent < n && hs(t, "deficient indentation"), r;
}
function Ds(t) {
  var e = t.position, n;
...
function tl(t, e) {
  e === 1 ? t.result += " " : e > 1 && (t.result += ln.repeat(`
`, e - 1));
}
function _E(t, e, n) {
  var r, i, s, a, o, l, f, c, u = t.kind, h = t.result, p;
  if (p = t.input.charCodeAt(t.position), Je(p) || kn(p) || p === 35 || p === 38 || p === 42 || p === 33 || p === 124 || p === 62 || p === 39 || p === 34 || p === 37 || p === 64 || p === 96 || (p === 63 || p === 45) && (i = t.input.charCodeAt(t.position + 1), Je(i) || n && kn(i)))
    return !1;
  for (t.kind = "scalar", t.result = "", s = a = t.position, o = !1; p !== 0; ) {
    if (p === 58) {
      if (i = t.input.charCodeAt(t.position + 1), Je(i) || n && kn(i))
        break;
    } else if (p === 35) {
      if (r = t.input.charCodeAt(t.position - 1), Je(r))
        break;
    } else {
      if (t.position === t.lineStart && Ds(t) || n && kn(p))
        break;
      if (bt(p))
    ...
    o && (qt(t, s, a, !1), tl(t, t.line - l), s = a = t.position, o = !1), mn(p) || (a = t.position + 1), p = t.input.charCodeAt(++t.position);
  }
  return qt(t, s, a, !1), t.result ? !0 : (t.kind = u, t.result = h, !1);
}
function yE(t, e) {
  var n, r, i;
  ...
  for (t.kind = "scalar", t.result = "", t.position++, r = i = t.position; (n = t.input.charCodeAt(t.position)) !== 0; )
    if (n === 39)
      if (qt(t, r, t.position, !0), n = t.input.charCodeAt(++t.position), n === 39)
        r = t.position, t.position++, i = t.position;
      else
        return !0;
    else bt(n) ? (qt(t, r, i, !0), tl(t, _e(t, !1, e)), r = i = t.position) : t.position === t.lineStart && Ds(t) ? q(t, "unexpected end of the document within a single quoted scalar") : (t.position++, i = t.position);
...
function wE(t, e) {
  ...
  for (t.kind = "scalar", t.result = "", t.position++, n = r = t.position; (o = t.input.charCodeAt(t.position)) !== 0; ) {
    if (o === 34)
      return qt(t, n, t.position, !0), t.position++, !0;
    if (o === 92) {
      if (qt(t, n, t.position, !0), o = t.input.charCodeAt(++t.position), bt(o))
        _e(t, !1, e);
      else if (o < 256 && lh[o])
      ...
      n = r = t.position;
    } else bt(o) ? (qt(t, n, r, !0), tl(t, _e(t, !1, e)), n = r = t.position) : t.position === t.lineStart && Ds(t) ? q(t, "unexpected end of the document within a double quoted scalar") : (t.position++, r = t.position);
  }
...
function vE(t, e) {
  ...
  for (t.kind = "scalar", t.result = ""; u !== 0; )
    if (u = t.input.charCodeAt(++t.position), u === 43 || u === 45)
      Ra === i ? i = u === 43 ? Bc : lE : q(t, "repeat of a chomping mode identifier");
    else if ((c = pE(u)) >= 0)
  ...
  for (; u !== 0; ) {
    ...
    if (t.lineIndent < o) {
      i === Bc ? t.result += ln.repeat(`
`, s ? 1 + l : l) : i === Ra && s && (t.result += `
`);
      break;
    }
    for (r ? mn(u) ? (f = !0, t.result += ln.repeat(`
`, s ? 1 + l : l)) : f ? (f = !1, t.result += ln.repeat(`
`, l + 1)) : l === 0 ? s && (t.result += " ") : t.result += ln.repeat(`
`, l) : t.result += ln.repeat(`
...
function Wc(t, e) {
  ...
  for (t.anchor !== null && (t.anchorMap[t.anchor] = s), l = t.input.charCodeAt(t.position); l !== 0 && (t.firstTabInLine !== -1 && (t.position = t.firstTabInLine, q(t, "tab characters must not be used in indentation")), !(l !== 45 || (a = t.input.charCodeAt(t.position + 1), !Je(a)))); ) {
    ...
    if (n = t.line, zn(t, e, ih, !1, !0), s.push(t.result), _e(t, !0, -1), l = t.input.charCodeAt(t.position), (t.line === n || t.lineIndent > e) && l !== 0)
...
function bE(t, e, n) {
  ...
  for (t.anchor !== null && (t.anchorMap[t.anchor] = u), A = t.input.charCodeAt(t.position); A !== 0; ) {
    if (!E && t.firstTabInLine !== -1 && (t.position = t.firstTabInLine, q(t, "tab characters must not be used in indentation")), r = t.input.charCodeAt(t.position + 1), s = t.line, (A === 63 || A === 58) && Je(r))
      A === 63 ? (E && (Un(t, u, h, p, y, null, a, o, l), p = y = _ = null), C = !0, E = !0, i = !0) : E ? (E = !1, i = !0) : q(t, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), t.position += 1, A = r;
    else {
      if (a = t.line, o = t.lineStart, l = t.position, !zn(t, n, rh, !1, !0))
        break;
      if (t.line === s) {
        for (A = t.input.charCodeAt(t.position); mn(A); )
          A = t.input.charCodeAt(++t.position);
        if (A === 58)
          A = t.input.charCodeAt(++t.position), Je(A) || q(t, "a whitespace character is expected after the key-value separator within a block mapping"), E && (Un(t, u, h, p, y, null, a, o, l), p = y = _ = null), C = !0, E = !1, i = !1, p = t.tag, y = t.result;
        else if (C)
    ...
    if ((t.line === s || t.lineIndent > e) && (E && (a = t.line, o = t.lineStart, l = t.position), zn(t, e, ds, !0, i) && (E ? y = t.result : _ = t.result), E || (Un(t, u, h, p, y, _, a, o, l), p = y = _ = null), _e(t, !0, -1), A = t.input.charCodeAt(t.position)), (t.line === s || t.lineIndent > e) && A !== 0)
      q(t, "bad indentation of a mapping entry");
    else if (t.lineIndent < e)
      break;
  }
  return E && Un(t, u, h, p, y, null, a, o, l), C && (t.tag = f, t.anchor = c, t.kind = "mapping", t.result = u), C;
}
function AE(t) {
  var e, n = !1, r = !1, i, s, a;
  ...
  return n ? t.tag = s : Vt.call(t.tagMap, i) ? t.tag = t.tagMap[i] + s : i === "!" ? t.tag = "!" + s : i === "!!" ? t.tag = "tag:yaml.org,2002:" + s : q(t, 'undeclared tag handle "' + i + '"'), !0;
}
function SE(t) {
  var e, n;
  if (n = t.input.charCodeAt(t.position), n !== 38) return !1;
  for (t.anchor !== null && q(t, "duplication of an anchor property"), n = t.input.charCodeAt(++t.position), e = t.position; n !== 0 && !Je(n) && !kn(n); )
...
function CE(t) {
  ...
  for (r = t.input.charCodeAt(++t.position), e = t.position; r !== 0 && !Je(r) && !kn(r); )
    r = t.input.charCodeAt(++t.position);
  return t.position === e && q(t, "name of an alias node must contain at least one character"), n = t.input.slice(e, t.position), Vt.call(t.anchorMap, n) || q(t, 'unidentified alias "' + n + '"'), t.result = t.anchorMap[n], _e(t, !0, -1), !0;
}
function zn(t, e, n, r, i) {
  var s, a, o, l = 1, f = !1, c = !1, u, h, p, y, _, E;
  if (t.listener !== null && t.listener("open", t), t.tag = null, t.anchor = null, t.kind = null, t.result = null, s = a = o = ds === n || ih === n, r && _e(t, !0, -1) && (f = !0, t.lineIndent > e ? l = 1 : t.lineIndent === e ? l = 0 : t.lineIndent < e && (l = -1)), l === 1)
    for (; AE(t) || SE(t); )
      _e(t, !0, -1) ? (f = !0, o = s, t.lineIndent > e ? l = 1 : t.lineIndent === e ? l = 0 : t.lineIndent < e && (l = -1)) : o = !1;
  if (o && (o = f || i), (l === 1 || ds === n) && (fs === n || rh === n ? _ = e : _ = e + 1, E = t.position - t.lineStart, l === 1 ? o && (Wc(t, E) || bE(t, E, _)) || EE(t, _) ? c = !0 : (a && vE(t, _) || yE(t, _) || wE(t, _) ? c = !0 : CE(t) ? (c = !0, (t.tag !== null || t.anchor !== null) && q(t, "alias node should not have any properties")) : _E(t, _, fs === n) && (c = !0, t.tag === null && (t.tag = "?")), t.anchor !== null && (t.anchorMap[t.anchor] = t.result)) : l === 0 && (c = o && Wc(t, E))), t.tag === null)
    ...
    if (Vt.call(t.typeMap[t.kind || "fallback"], t.tag))
...
function TE(t) {
  ...
  for (t.version = null, t.checkLineBreaks = t.legacy, t.tagMap = /* @__PURE__ */ Object.create(null), t.anchorMap = /* @__PURE__ */ Object.create(null); (a = t.input.charCodeAt(t.position)) !== 0 && (_e(t, !0, -1), a = t.input.charCodeAt(t.position), !(t.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && el(t), Vt.call(qc, r) ? qc[r](t, r, i) : hs(t, 'unknown document directive "' + r + '"');
  }
  if (_e(t, !0, -1), t.lineIndent === 0 && t.input.charCodeAt(t.position) === 45 && t.input.charCodeAt(t.position + 1) === 45 && t.input.charCodeAt(t.position + 2) === 45 ? (t.position += 3, _e(t, !0, -1)) : s && q(t, "directives end mark is expected"), zn(t, t.lineIndent - 1, ds, !1, !0), _e(t, !0, -1), t.checkLineBreaks && uE.test(t.input.slice(e, t.position)) && hs(t, "non-ASCII line breaks are interpreted as content"), t.documents.push(t.result), t.position === t.lineStart && Ds(t)) {
...
Jo.loadAll = RE;
Jo.load = IE;
var dh = {}, Fs = dt, ti = ei, OE = Zo, hh = Object.prototype.toString, ph = Object.prototype.hasOwnProperty, nl = 65279, $E = 9, Lr = 10, PE = 13, xE = 32, NE = 33, DE = 34, ho = 35, FE = 37, LE = 38, kE = 39, UE = 42, mh = 44, ME = 45, ps = 58, BE = 61, jE = 62, HE = 63, qE = 64, gh = 91, _h = 93, GE = 96, yh = 123, WE = 124, wh = 125, Ue = {};
Ue[0] = "\\0";
Ue[7] = "\\a";
Ue[8] = "\\b";
Ue[9] = "\\t";
...
function XE(t) {
  ...
  return "\\" + n + Fs.repeat("0", r - e.length) + e;
}
var KE = 1, kr = 2;
function JE(t) {
...
function Vc(t, e) {
  for (var n = Fs.repeat(" ", e), r = 0, i = -1, s = "", a, o = t.length; r < o; )
    i = t.indexOf(`
...
function Yc(t, e, n) {
  ...
  return (
    ...
    (n ? (
      // c = flow-in
      r
    ) : r && t !== mh && t !== gh && t !== _h && t !== yh && t !== wh) && t !== ho && !(e === ps && !i) || zc(e) && !ms(e) && t === ho || e === ps && i
  );
}
function ZE(t) {
  return Ur(t) && t !== nl && !ms(t) && t !== ME && t !== HE && t !== ps && t !== mh && t !== gh && t !== _h && t !== yh && t !== wh && t !== ho && t !== LE && t !== UE && t !== NE && t !== WE && t !== BE && t !== jE && t !== kE && t !== DE && t !== FE && t !== qE && t !== GE;
}
function ev(t) {
  return !ms(t) && t !== ps;
}
...
function tv(t, e, n, r, i, s, a, o) {
  ...
  return !u && !h ? _ && !a && !i(t) ? vh : s === kr ? xn : mo : n > 9 && Eh(t) ? xn : a ? s === kr ? xn : mo : h ? Ah : bh;
}
...
function sv(t, e, n) {
  ...
  for (s = 0, a = n.length; s < a; s += 1)
    o = n[s], t.replacer && (o = t.replacer.call(n, String(s), o)), ($t(t, e, o, !1, !1) || typeof o > "u" && $t(t, e, null, !1, !1)) && (r !== "" && (r += "," + (t.condenseFlow ? "" : " ")), r += t.dump);
  t.tag = i, t.dump = "[" + r + "]";
}
function Qc(t, e, n, r) {
  var i = "", s = t.tag, a, o, l;
  for (a = 0, o = n.length; a < o; a += 1)
    l = n[a], t.replacer && (l = t.replacer.call(n, String(a), l)), ($t(t, e + 1, l, !0, !0, !1, !0) || typeof l > "u" && $t(t, e + 1, null, !0, !0, !1, !0)) && ((!r || i !== "") && (i += po(t, e)), t.dump && Lr === t.dump.charCodeAt(0) ? i += "-" : i += "- ", i += t.dump);
  t.tag = s, t.dump = i || "[]";
}
function av(t, e, n) {
  var r = "", i = t.tag, s = Object.keys(n), a, o, l, f, c;
  for (a = 0, o = s.length; a < o; a += 1)
    c = "", r !== "" && (c += ", "), t.condenseFlow && (c += '"'), l = s[a], f = n[l], t.replacer && (f = t.replacer.call(n, l, f)), $t(t, e, l, !1, !1) && (t.dump.length > 1024 && (c += "? "), c += t.dump + (t.condenseFlow ? '"' : "") + ":" + (t.condenseFlow ? "" : " "), $t(t, e, f, !1, !1) && (c += t.dump, r += c));
  t.tag = i, t.dump = "{" + r + "}";
}
function ov(t, e, n, r) {
  ...
  for (o = 0, l = a.length; o < l; o += 1)
    h = "", (!r || i !== "") && (h += po(t, e)), f = a[o], c = n[f], t.replacer && (c = t.replacer.call(n, f, c)), $t(t, e + 1, f, !0, !0, !0) && (u = t.tag !== null && t.tag !== "?" || t.dump && t.dump.length > 1024, u && (t.dump && Lr === t.dump.charCodeAt(0) ? h += "?" : h += "? "), h += t.dump, u && (h += po(t, e)), $t(t, e + 1, c, !0, u) && (t.dump && Lr === t.dump.charCodeAt(0) ? h += ":" : h += ": ", h += t.dump, i += h));
  t.tag = s, t.dump = i || "{}";
}
function Zc(t, e, n) {
  var r, i, s, a, o, l;
...
function lv(t, e) {
  var n = [], r = [], i, s;
  for (go(t, n, r), i = 0, s = r.length; i < s; i += 1)
...
function cv(t, e) {
  ...
  n.noRefs || lv(t, n);
  var r = t;
  return n.replacer && (r = n.replacer.call({ "": r }, "", r)), $t(n, 0, r, !0, !0) ? n.dump + `
` : "";
}
dh.dump = cv;
var Sh = Jo, uv = dh;
...
const Ti = Us, { MAX_LENGTH: tu, MAX_SAFE_INTEGER: Ri } = ks, { safeRe: Ii, t: Oi } = ni, bv = il, { compareIdentifiers: Ia } = Rh;
let Av = class wt {
  constructor(e, n) {
  ...
  inc(e, n, r) {
    ...
    switch (e) {
      ...
      case "pre": {
        ...
        if (n) {
          let s = [n, i];
          r === !1 && (s = [n]), Ia(this.prerelease[0], n) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = s) : this.prerelease = s;
        }
        break;
      }
      default:
...
var ll = yb;
const wb = Ih, Eb = Oh, vb = Ms, bb = ol, Ab = al, Sb = ll, Cb = (t, e, n, r) => {
  switch (e) {
    case "===":
...
var $h = Cb;
const Tb = Ye, Rb = Jn, { safeRe: $i, t: Pi } = ni, Ib = (t, e) => {
  if (t instanceof Tb)
    return t;
...
function pt() {
  ...
  Oa = e;
  const n = Pb, r = new n(), i = il, s = Bs(), a = Us, o = Ye, {
    safeRe: l,
    t: f,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: h
  } = ni, { FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: y } = ks, _ = (N) => N.value === "<0.0.0-0", E = (N) => N.value === "", C = (N, $) => {
    let F = !0;
    const I = N.slice();
    let k = I.pop();
    for (; F && I.length; )
...
function Bs() {
  ...
  $a = e;
  const n = il, { safeRe: r, t: i } = ni, s = $h, a = Us, o = Ye, l = pt();
  return $a;
}
...
var Gb = qb;
const Pa = Ye, Wb = pt(), cu = Ms, Vb = (t, e) => {
  t = new Wb(t, e);
  let n = new Pa("0.0.0");
  if (t.test(n) || (n = new Pa("0.0.0-0"), t.test(n)))
    return n;
  n = null;
  for (let r = 0; r < t.set.length; ++r) {
    ...
    let s = null;
    i.forEach((a) => {
      const o = new Pa(a.semver.version);
      switch (a.operator) {
        case ">":
...
var Kb = Xb;
const Jb = Ye, Ph = Bs(), { ANY: Qb } = Ph, Zb = pt(), eA = js, uu = Ms, fu = al, tA = ll, nA = ol, rA = (t, e, n, r) => {
...
const hu = pt(), ul = Bs(), { ANY: xa } = ul, lr = js, fl = ht, mA = (t, e, n = {}) => {
  if (t === e)
    return !0;
  ...
  if (t === e)
    return !0;
  if (t.length === 1 && t[0].semver === xa) {
    if (e.length === 1 && e[0].semver === xa)
      return !0;
  ...
  for (const p of r) {
    if (i && !lr(p, String(i), n) || s && !lr(p, String(s), n))
      return null;
    for (const y of e)
      if (!lr(p, String(y), n))
        return !1;
    ...
    if (c = c || p.operator === ">" || p.operator === ">=", f = f || p.operator === "<" || p.operator === "<=", i) {
      if (h && p.semver.prerelease && p.semver.prerelease.length && p.semver.major === h.major && p.semver.minor === h.minor && p.semver.patch === h.patch && (h = !1), p.operator === ">" || p.operator === ">=") {
        if (o = mu(i, p, n), o === p && o !== i)
          return !1;
      } else if (i.operator === ">=" && !lr(i.semver, String(p), n))
        return !1;
    }
    if (s) {
      if (u && p.semver.prerelease && p.semver.prerelease.length && p.semver.major === u.major && p.semver.minor === u.minor && p.semver.patch === u.patch && (u = !1), p.operator === "<" || p.operator === "<=") {
        if (l = gu(s, p, n), l === p && l !== s)
          return !1;
      } else if (s.operator === "<=" && !lr(s.semver, String(p), n))
        return !1;
    }
...
var yA = mA;
const Na = ni, _u = ks, wA = Ye, yu = Rh, EA = Jn, vA = Rv, bA = $v, AA = xv, SA = Dv, CA = kv, TA = Bv, RA = qv, IA = Vv, OA = ht, $A = Kv, PA = Zv, xA = sl, NA = rb, DA = ab, FA = Ms, LA = al, kA = Ih, UA = Oh, MA = ol, BA = ll, jA = $h, HA = Ob, qA = Bs(), GA = pt(), WA = js, VA = Lb, zA = Bb, YA = Gb, XA = zb, KA = Kb, JA = cl, QA = aA, ZA = cA, eS = fA, tS = pA, nS = yA;
var xh = {
  parse: EA,
  valid: vA,
  clean: bA,
...
(function(t, e) {
  ...
  var Nm = Array.prototype, Dm = Function.prototype, di = Object.prototype, ca = d["__core-js_shared__"], Hl = Dm.toString, _t = di.hasOwnProperty, ql = function() {
  ...
  ), Wl = ne ? d.Buffer : void 0, hi = d.Symbol, Vl = d.Uint8Array, zl = di.propertyIsEnumerable, Lm = Nm.splice, Qt = hi ? hi.toStringTag : void 0, Yl = Object.getOwnPropertySymbols, km = Wl ? Wl.isBuffer : void 0, Um = Pm(Object.keys, Object), ua = An(d, "DataView"), rr = An(d, "Map"), fa = An(d, "Promise"), da = An(d, "Set"), ha = An(d, "WeakMap"), ir = An(Object, "create"), Mm = tn(ua), Bm = tn(rr), jm = tn(fa), Hm = tn(da), qm = tn(ha), Xl = hi ? hi.prototype : void 0, pa = Xl ? Xl.valueOf : void 0;
  function Zt(g) {
  ...
  function zm(g) {
    var v = this.__data__;
    return ir ? v[g] !== void 0 : _t.call(v, g);
  }
  function Ym(g, v) {
    var P = this.__data__;
    return this.size += this.has(g) ? 0 : 1, P[g] = ir && v === void 0 ? r : v, this;
  }
  Zt.prototype.clear = Gm, Zt.prototype.delete = Wm, Zt.prototype.get = Vm, Zt.prototype.has = zm, Zt.prototype.set = Ym;
  function St(g) {
    var v = -1, P = g == null ? 0 : g.length;
    for (this.clear(); ++v < P; ) {
      var B = g[v];
  ...
  en.prototype.clear = eg, en.prototype.delete = tg, en.prototype.get = ng, en.prototype.has = rg, en.prototype.set = ig;
  function pi(g) {
    var v = -1, P = g == null ? 0 : g.length;
    for (this.__data__ = new en(); ++v < P; )
      this.add(g[v]);
  }
  function sg(g) {
  ...
  function fg(g, v) {
    ...
    if (P instanceof St) {
      ...
      P = this.__data__ = new en(B);
    }
    return P.set(g, v), this.size = P.size, this;
  }
  Nt.prototype.clear = og, Nt.prototype.delete = lg, Nt.prototype.get = cg, Nt.prototype.has = ug, Nt.prototype.set = fg;
  function dg(g, v) {
    var P = _i(g), B = !P && Rg(g), ce = !P && !B && ma(g), Z = !P && !B && !ce && ic(g), me = P || B || ce || Z, Ce = me ? at(g.length, String) : [], Oe = Ce.length;
    for (var ue in g)
  ...
  function hg(g, v, P) {
    var B = v(g);
    return _i(g) ? B : xt(B, P(g));
  }
  function sr(g) {
    return g == null ? g === void 0 ? w : C : Qt && Qt in Object(g) ? Eg(g) : Tg(g);
  }
  function Kl(g) {
    return ar(g) && sr(g) == o;
  }
  function Jl(g, v, P, B, ce) {
    return g === v ? !0 : g == null || v == null || !ar(g) && !ar(v) ? g !== g && v !== v : pg(g, v, P, B, Jl, ce);
  }
  function pg(g, v, P, B, ce, Z) {
    var me = _i(g), Ce = _i(v), Oe = me ? l : Dt(g), ue = Ce ? l : Dt(v);
    ...
    if (Le && !Ze)
      return Z || (Z = new Nt()), me || ic(g) ? Ql(g, v, P, B, ce, Z) : yg(g, v, Oe, P, B, ce, Z);
    if (!(P & i)) {
      var rt = Ze && _t.call(g, "__wrapped__"), it = ot && _t.call(v, "__wrapped__");
      if (rt || it) {
        var Ft = rt ? g.value() : g, Ct = it ? v.value() : v;
        return Z || (Z = new Nt()), ce(Ft, Ct, P, B, Z);
      }
    }
    return Le ? (Z || (Z = new Nt()), wg(g, v, P, B, ce, Z)) : !1;
  }
  function mg(g) {
    if (!rc(g) || Sg(g))
      return !1;
  ...
  function gg(g) {
    return ar(g) && nc(g.length) && !!V[sr(g)];
  }
  function _g(g) {
    if (!Cg(g))
      return Um(g);
  ...
  function Ql(g, v, P, B, ce, Z) {
    ...
    for (Z.set(g, v), Z.set(v, g); ++Ze < Ce; ) {
      var rt = g[Ze], it = v[Ze];
      if (B)
        var Ft = me ? B(it, rt, Ze, v, g, Z) : B(rt, it, Ze, g, v, Z);
      if (Ft !== void 0) {
        if (Ft)
          continue;
        ot = !1;
      ...
      if (Le) {
        if (!Ee(v, function(Ct, nn) {
          if (!ui(Le, nn) && (rt === Ct || ce(rt, Ct, P, B, Z)))
            return Le.push(nn);
        })) {
          ot = !1;
          break;
  ...
  function wg(g, v, P, B, ce, Z) {
    ...
    for (var Ft = me; ++ot < Oe; ) {
      ...
      var Ct = g[Le], nn = v[Le];
      if (B)
        var sc = me ? B(nn, Ct, Le, v, g, Z) : B(Ct, nn, Le, g, v, Z);
      if (!(sc === void 0 ? Ct === nn || ce(Ct, nn, P, B, Z) : sc)) {
        it = !1;
        break;
      }
  ...
  function Eg(g) {
    ...
    var ce = Gl.call(g);
    return B && (v ? g[Qt] = P : delete g[Qt]), ce;
  }
  ...
  (ua && Dt(new ua(new ArrayBuffer(1))) != W || rr && Dt(new rr()) != _ || fa && Dt(fa.resolve()) != O || da && Dt(new da()) != Y || ha && Dt(new ha()) != j) && (Dt = function(g) {
    var v = sr(g), P = v == A ? g.constructor : void 0, B = P ? tn(P) : "";
    if (B)
      switch (B) {
        case Mm:
          return W;
  ...
  var Rg = Kl(/* @__PURE__ */ function() {
    ...
    return ar(g) && _t.call(g, "callee") && !zl.call(g, "callee");
  }, _i = Array.isArray;
  function Ig(g) {
...
const iS = yn, sS = ye, wu = rS, sn = Kt, Tr = he;
class aS {
  constructor(e) {
  ...
  async validateDownloadedPath(e, n, r, i) {
    if (this.versionInfo != null && this.file === e && this.fileInfo != null)
      return wu(this.versionInfo, n) && wu(this.fileInfo.info, r.info) && await (0, sn.pathExists)(e) ? e : null;
  ...
  async getValidCachedUpdateFile(e, n) {
    ...
    if (!await (0, sn.pathExists)(r))
      return null;
    let s;
    try {
      s = await (0, sn.readJson)(r);
    } catch (f) {
...
function uS() {
  ...
  let e;
  return process.platform === "win32" ? e = process.env.LOCALAPPDATA || Da.join(t, "AppData", "Local") : process.platform === "darwin" ? e = Da.join(t, "Library", "Caches") : e = process.env.XDG_CACHE_HOME || Da.join(t, ".cache"), e;
}
Object.defineProperty(Hs, "__esModule", { value: !0 });
Hs.ElectronAppAdapter = void 0;
const Eu = he, fS = dl;
class dS {
  constructor(e = gn.app) {
    this.app = e;
  }
  whenReady() {
...
(function(t) {
  ...
  function n() {
    return gn.session.fromPartition(t.NET_SESSION_NAME, {
      cache: !1
    });
  }
...
we.getFileList = kh;
we.resolveFiles = DS;
const zt = Ae, IS = De, OS = Xt, _s = mt, $S = Lh;
class PS {
  constructor(e) {
  ...
  getBlockMapFiles(e, n, r, i = null) {
    const s = (0, _s.newUrlFromBase)(`${e.pathname}.blockmap`, e);
    return [(0, _s.newUrlFromBase)(`${e.pathname.replace(new RegExp($S(r), "g"), n)}.blockmap`, i ? new OS.URL(i) : e), s];
  }
  ...
  createRequestOptions(e, n) {
    const r = {};
    return this.requestHeaders == null ? n != null && (r.headers = n) : r.headers = n == null ? this.requestHeaders : { ...this.requestHeaders, ...n }, (0, zt.configureRequestUrl)(e, r), r;
  }
}
we.Provider = PS;
function xS(t, e, n) {
  var r;
  if (t.length === 0)
    throw (0, zt.newError)("No files provided", "ERR_UPDATER_NO_FILES_PROVIDED");
...
function NS(t, e, n) {
  if (t == null)
    throw (0, zt.newError)(`Cannot parse update info from ${e} in the latest release artifacts (${n}): rawData: null`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  let r;
  try {
    r = (0, IS.load)(t);
  } catch (i) {
    throw (0, zt.newError)(`Cannot parse update info from ${e} in the latest release artifacts (${n}): ${i.stack || i.message}, rawData: ${t}`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  }
  return r;
}
function kh(t) {
  ...
  throw (0, zt.newError)(`No files provided: ${(0, zt.safeStringifyJson)(t)}`, "ERR_UPDATER_NO_FILES_PROVIDED");
}
function DS(t, e, n = (r) => r) {
  const i = kh(t).map((o) => {
    if (o.sha2 == null && o.sha512 == null)
      throw (0, zt.newError)(`Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, zt.safeStringifyJson)(o)}`, "ERR_UPDATER_NO_CHECKSUM");
    return {
      url: (0, _s.newUrlFromBase)(n(o.url), e),
      info: o
    };
  }), s = t.packages, a = s == null ? null : s[process.arch] || s.ia32;
  return a != null && (i[0].packageInfo = {
    ...a,
    path: (0, _s.newUrlFromBase)(n(a.path), e).href
  }), i;
}
Object.defineProperty(ii, "__esModule", { value: !0 });
ii.GenericProvider = void 0;
const Su = Ae, Fa = mt, La = we;
class FS extends La.Provider {
  constructor(e, n, r) {
    super(r), this.configuration = e, this.updater = n, this.baseUrl = (0, Fa.newBaseUrl)(this.configuration.url);
  }
  get channel() {
  ...
  async getLatestVersion() {
    const e = (0, Fa.getChannelFilename)(this.channel), n = (0, Fa.newUrlFromBase)(e, this.baseUrl, this.updater.isAddNoCacheQuery);
    for (let r = 0; ; r++)
      try {
        return (0, La.parseUpdateInfo)(await this.httpRequest(n), e, n);
      } catch (i) {
  ...
  resolveFiles(e) {
    return (0, La.resolveFiles)(e, this.baseUrl);
  }
}
ii.GenericProvider = FS;
var qs = {}, Gs = {};
Object.defineProperty(Gs, "__esModule", { value: !0 });
Gs.BitbucketProvider = void 0;
const Cu = Ae, ka = mt, Ua = we;
class LS extends Ua.Provider {
  constructor(e, n, r) {
    super({
      ...r,
    ...
    this.baseUrl = (0, ka.newBaseUrl)(`https://api.bitbucket.org/2.0/repositories/${i}/${s}/downloads`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "latest";
  }
  async getLatestVersion() {
    const e = new Cu.CancellationToken(), n = (0, ka.getChannelFilename)(this.getCustomChannelName(this.channel)), r = (0, ka.newUrlFromBase)(n, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(r, void 0, e);
      return (0, Ua.parseUpdateInfo)(i, n, r);
    } catch (i) {
  ...
  resolveFiles(e) {
    return (0, Ua.resolveFiles)(e, this.baseUrl);
  }
  toString() {
...
Gs.BitbucketProvider = LS;
var Yt = {};
Object.defineProperty(Yt, "__esModule", { value: !0 });
Yt.GitHubProvider = Yt.BaseGitHubProvider = void 0;
Yt.computeReleaseNotes = Mh;
const Ot = Ae, un = xh, kS = Xt, Mn = mt, yo = we, Ma = /\/tag\/([^/]+)$/;
class Uh extends yo.Provider {
  constructor(e, n, r) {
    super({
      ...r,
      /* because GitHib uses S3 */
      isUseMultipleRangeRequest: !1
    }), this.options = e, this.baseUrl = (0, Mn.newBaseUrl)((0, Ot.githubUrl)(e, n));
    const i = n === "github.com" ? "api.github.com" : n;
    this.baseApiUrl = (0, Mn.newBaseUrl)((0, Ot.githubUrl)(e, i));
  }
...
class US extends Uh {
  ...
  async getLatestVersion() {
    var e, n, r, i, s;
    const a = new Ot.CancellationToken(), o = await this.httpRequest((0, Mn.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, a), l = (0, Ot.parseXml)(o);
    let f = l.element("entry", !1, "No published versions on GitHub"), c = null;
    try {
      if (this.updater.allowPrerelease) {
        const E = ((e = this.updater) === null || e === void 0 ? void 0 : e.channel) || ((n = un.prerelease(this.updater.currentVersion)) === null || n === void 0 ? void 0 : n[0]) || null;
        if (E === null)
          c = Ma.exec(f.element("link").attribute("href"))[1];
        else
          for (const C of l.getElements("entry")) {
            const A = Ma.exec(C.element("link").attribute("href"));
            if (A === null)
              continue;
            const O = A[1], T = ((r = un.prerelease(O)) === null || r === void 0 ? void 0 : r[0]) || null, K = !E || ["alpha", "beta"].includes(E), Y = T !== null && !["alpha", "beta"].includes(String(T));
        ...
        for (const E of l.getElements("entry"))
          if (Ma.exec(E.element("link").attribute("href"))[1] === c) {
            f = E;
            break;
          }
      }
    } catch (E) {
      throw (0, Ot.newError)(`Cannot parse releases feed: ${E.stack || E.message},
XML:
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    }
    if (c == null)
      throw (0, Ot.newError)("No published versions on GitHub", "ERR_UPDATER_NO_PUBLISHED_VERSIONS");
    let u, h = "", p = "";
    const y = async (E) => {
      h = (0, Mn.getChannelFilename)(E), p = (0, Mn.newUrlFromBase)(this.getBaseDownloadPath(String(c), h), this.baseUrl);
      const C = this.createRequestOptions(p);
      try {
        return await this.executor.request(C, a);
      } catch (A) {
        throw A instanceof Ot.HttpError && A.statusCode === 404 ? (0, Ot.newError)(`Cannot find ${h} in the latest release artifacts (${p}): ${A.stack || A.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : A;
      }
    };
    try {
      let E = this.channel;
      this.updater.allowPrerelease && (!((i = un.prerelease(c)) === null || i === void 0) && i[0]) && (E = this.getCustomChannelName(String((s = un.prerelease(c)) === null || s === void 0 ? void 0 : s[0]))), u = await y(E);
    } catch (E) {
      if (this.updater.allowPrerelease)
    ...
    const _ = (0, yo.parseUpdateInfo)(u, h, p);
  ...
  async getLatestTagName(e) {
    const n = this.options, r = n.host == null || n.host === "github.com" ? (0, Mn.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new kS.URL(`${this.computeGithubBasePath(`/repos/${n.owner}/${n.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
      const i = await this.httpRequest(r, { Accept: "application/json" }, e);
      return i == null ? null : JSON.parse(i).tag_name;
    } catch (i) {
      throw (0, Ot.newError)(`Unable to find latest version on GitHub (${r}), please ensure a production release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  get basePath() {
  ...
  resolveFiles(e) {
    return (0, yo.resolveFiles)(e, this.baseUrl, (n) => this.getBaseDownloadPath(e.tag, n.replace(/ /g, "-")));
  }
  getBaseDownloadPath(e, n) {
    return `${this.basePath}/download/${e}/${n}`;
  }
}
Yt.GitHubProvider = US;
function Tu(t) {
...
function Mh(t, e, n, r) {
  ...
  for (const s of n.getElements("entry")) {
    ...
    un.valid(a) && un.lt(t, a) && i.push({
      version: a,
      note: Tu(s)
    });
  }
  return i.sort((s, a) => un.rcompare(s.version, a.version));
}
var Ws = {};
Object.defineProperty(Ws, "__esModule", { value: !0 });
Ws.GitLabProvider = void 0;
const Me = Ae, Ba = Xt, MS = Lh, xi = mt, ja = we;
class BS extends ja.Provider {
  /**
  ...
  async getLatestVersion() {
    ...
    const l = async (h) => {
      ...
      o = new Ba.URL(p.direct_asset_url);
    ...
    const f = (0, ja.parseUpdateInfo)(s, a, o);
  ...
  resolveFiles(e) {
    return (0, ja.getFileList)(e).map((n) => {
      const i = [
        n.url,
        // Original filename
...
Ws.GitLabProvider = BS;
var Vs = {};
Object.defineProperty(Vs, "__esModule", { value: !0 });
Vs.KeygenProvider = void 0;
const Ru = Ae, Ha = mt, qa = we;
class jS extends qa.Provider {
  constructor(e, n, r) {
    super({
      ...r,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const e = new Ru.CancellationToken(), n = (0, Ha.getChannelFilename)(this.getCustomChannelName(this.channel)), r = (0, Ha.newUrlFromBase)(n, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(r, {
        Accept: "application/vnd.api+json",
        "Keygen-Version": "1.1"
      }, e);
      return (0, qa.parseUpdateInfo)(i, n, r);
    } catch (i) {
  ...
  resolveFiles(e) {
    return (0, qa.resolveFiles)(e, this.baseUrl);
  }
  toString() {
...
Vs.KeygenProvider = jS;
var zs = {};
Object.defineProperty(zs, "__esModule", { value: !0 });
zs.PrivateGitHubProvider = void 0;
const Tn = Ae, HS = De, qS = he, Iu = Xt, Ou = mt, GS = Yt, WS = we;
class VS extends GS.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const e = new Tn.CancellationToken(), n = (0, Ou.getChannelFilename)(this.getDefaultChannelName()), r = await this.getLatestVersionInfo(e), i = r.assets.find((o) => o.name === n);
    if (i == null)
    ...
    try {
      ...
      throw o instanceof Tn.HttpError && o.statusCode === 404 ? (0, Tn.newError)(`Cannot find ${n} in the latest release artifacts (${s}): ${o.stack || o.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : o;
    }
  ...
  async getLatestVersionInfo(e) {
    ...
    try {
      ...
      throw (0, Tn.newError)(`Unable to find latest version on GitHub (${i}), please ensure a production release exists: ${s.stack || s.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  get basePath() {
  ...
  resolveFiles(e) {
    return (0, WS.getFileList)(e).map((n) => {
      ...
      if (i == null)
        throw (0, Tn.newError)(`Cannot find asset "${r}" in: ${JSON.stringify(e.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
...
zs.PrivateGitHubProvider = VS;
Object.defineProperty(qs, "__esModule", { value: !0 });
qs.isUrlProbablySupportMultiRangeRequests = Bh;
qs.createClient = QS;
const Ni = Ae, zS = Gs, $u = ii, YS = Yt, XS = Ws, KS = Vs, JS = zs;
function Bh(t) {
...
bn.computeOperations = ZS;
var fn;
(function(t) {
  t[t.COPY = 0] = "COPY", t[t.DOWNLOAD = 1] = "DOWNLOAD";
})(fn || (bn.OperationKind = fn = {}));
function ZS(t, e, n) {
  ...
  for (let _ = 0; _ < c.checksums.length; y += c.sizes[_], _++) {
    ...
    let A = h.get(C);
    A != null && p.get(C) !== E && (n.warn(`Checksum ("${C}") matches, but size differs (old: ${p.get(C)}, new: ${E})`), A = void 0), A === void 0 ? (u++, s != null && s.kind === fn.DOWNLOAD && s.end === y ? s.end += E : (s = {
      kind: fn.DOWNLOAD,
      start: y,
      end: y + E
      // oldBlocks: null,
    }, Pu(s, o, C, _))) : s != null && s.kind === fn.COPY && s.end === A ? s.end += E : (s = {
      kind: fn.COPY,
      start: A,
      end: A + E
      // oldBlocks: [checksum]
...
function Pu(t, e, n, r) {
  if (eC && e.length !== 0) {
    ...
    if (i.kind === t.kind && t.start < i.end && t.start > i.start) {
      ...
      throw new Error(`operation (block index: ${r}, checksum: ${n}, kind: ${fn[t.kind]}) overlaps previous operation (checksum: ${n}):
...
Qn.DataSplitter = void 0;
Qn.copyData = jh;
const Di = Ae, nC = ye, rC = Xr, iC = bn, Nu = Buffer.from(`\r
\r
`);
var Mt;
(function(t) {
...
class sC extends rC.Writable {
  constructor(e, n, r, i, s, a, o, l) {
    super(), this.out = e, this.options = n, this.partIndexToTaskIndex = r, this.partIndexToLength = s, this.finishHandler = a, this.grandTotalBytes = o, this.onProgress = l, this.start = Date.now(), this.nextUpdate = this.start + 1e3, this.transferred = 0, this.delta = 0, this.partIndex = -1, this.headerListBuffer = null, this.readState = Mt.INIT, this.ignoreByteCount = 0, this.remainingPartDataCount = 0, this.actualPartLength = 0, this.boundaryLength = i.length + 4, this.ignoreByteCount = this.boundaryLength - 2;
  }
  get isFinished() {
...
Xs.executeTasksUsingMultipleRangeRequests = aC;
Xs.checkIsRangesSupported = Eo;
const wo = Ae, Du = Qn, Fu = bn;
...
function oC(t, e, n, r, i) {
  ...
  const u = t.httpExecutor.createRequest(c, (h) => {
    if (!Eo(h, i))
      return;
    const p = (0, wo.safeGetHeader)(h, "content-type"), y = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(p);
    if (y == null) {
...
function Eo(t, e) {
  if (t.statusCode >= 400)
    return e((0, wo.createHttpError)(t)), !1;
  if (t.statusCode !== 206) {
    const n = (0, wo.safeGetHeader)(t, "accept-ranges");
    if (n == null || n === "none")
...
Ks.ProgressDifferentialDownloadCallbackTransform = void 0;
const lC = Xr;
var Bn;
(function(t) {
  t[t.COPY = 0] = "COPY", t[t.DOWNLOAD = 1] = "DOWNLOAD";
...
class cC extends lC.Transform {
  constructor(e, n, r) {
    super(), this.progressDifferentialDownloadInfo = e, this.cancellationToken = n, this.onProgress = r, this.start = Date.now(), this.transferred = 0, this.delta = 0, this.expectedBytes = 0, this.index = 0, this.operationType = Bn.COPY, this.nextUpdate = this.start + 1e3;
  }
  _transform(e, n, r) {
    if (this.cancellationToken.cancelled) {
      r(new Error("cancelled"), null);
...
Ks.ProgressDifferentialDownloadCallbackTransform = cC;
Object.defineProperty(si, "__esModule", { value: !0 });
si.DifferentialDownloader = void 0;
const cr = Ae, Ga = Kt, uC = ye, fC = Qn, dC = Xt, Fi = bn, Lu = Xs, hC = Ks;
class pC {
  ...
  createRequestOptions() {
    ...
    return (0, cr.configureRequestUrl)(this.options.newUrl, e), (0, cr.configureRequestOptions)(e), e;
  }
  doDownload(e, n) {
  ...
  downloadFile(e) {
    const n = [], r = () => Promise.all(n.map((i) => (0, Ga.close)(i.descriptor).catch((s) => {
  ...
  async doDownloadFile(e, n) {
    const r = await (0, Ga.open)(this.options.oldFile, "r");
    ...
    await new Promise((a, o) => {
      ...
      E.redirect = "manual", p = (C) => {
        ...
        const Y = this.httpExecutor.createRequest(E, (U) => {
          ...
          }), U.statusCode >= 400 && o((0, cr.createHttpError)(U)), U.pipe(h, {
            end: !1
          }), U.once("end", () => {
        ...
        Y.on("redirect", (U, ie, w) => {
          this.logger.info(`Redirect to ${mC(w)}`), _ = w, (0, cr.configureRequestUrl)(new dC.URL(_), E), Y.followRedirect();
...
Ys.GenericDifferentialDownloader = void 0;
const gC = si;
...
Ys.GenericDifferentialDownloader = _C;
var Jt = {};
(function(t) {
...
const Be = Ae, yC = yn, wC = Is, EC = Nf, lt = Kt, vC = De, Wa = Ls, ct = he, an = xh, Uu = ri, bC = Hs, Mu = Nh, AC = ii, Va = qs, za = Ff, SC = Ys, Rn = Jt;
class hl extends EC.EventEmitter {
  ...
  set updateConfigPath(e) {
    this.clientPromise = null, this._appUpdateConfigPath = e, this.configOnDisk = new Wa.Lazy(() => this.loadUpdateConfig());
  }
  /**
  ...
  constructor(e, n) {
    super(), this.autoDownload = !0, this.autoInstallOnAppQuit = !0, this.autoRunAppAfterInstall = !0, this.allowPrerelease = !1, this.fullChangelog = !1, this.allowDowngrade = !1, this.disableWebInstaller = !1, this.disableDifferentialDownload = !1, this.forceDevUpdateConfig = !1, this.previousBlockmapBaseUrlOverride = null, this._channel = null, this.downloadedUpdateHelper = null, this.requestHeaders = null, this._logger = console, this.signals = new Rn.UpdaterSignal(this), this._appUpdateConfigPath = null, this._isUpdateSupported = (s) => this.checkIfUpdateSupported(s), this._isUserWithinRollout = (s) => this.isStagingMatch(s), this.clientPromise = null, this.stagingUserIdPromise = new Wa.Lazy(() => this.getOrCreateStagingUserId()), this.configOnDisk = new Wa.Lazy(() => this.loadUpdateConfig()), this.checkForUpdatesPromise = null, this.downloadPromise = null, this.updateInfoAndProvider = null, this._testOnlyOptions = null, this.on("error", (s) => {
    ...
    const r = this.app.version, i = (0, an.parse)(r);
    if (i == null)
  ...
  setFeedURL(e) {
    ...
    typeof e == "string" ? r = new AC.GenericProvider({ provider: "generic", url: e }, this, {
      ...n,
      isUseMultipleRangeRequest: (0, Va.isUrlProbablySupportMultiRangeRequests)(e)
    }) : r = (0, Va.createClient)(e, this, n), this.clientPromise = Promise.resolve(r);
  }
  /**
  ...
  async isUpdateAvailable(e) {
    ...
    if ((0, an.eq)(n, r) || !await Promise.resolve(this.isUpdateSupported(e)) || !await Promise.resolve(this.isUserWithinRollout(e)))
      return !1;
    const s = (0, an.gt)(n, r), a = (0, an.lt)(n, r);
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((r) => (0, Va.createClient)(r, this, this.createProviderRuntimeOptions())));
  ...
  dispatchUpdateDownloaded(e) {
    this.emit(Rn.UPDATE_DOWNLOADED, e);
  }
  ...
  async executeDownload(e) {
    ...
    this.listenerCount(Rn.DOWNLOAD_PROGRESS) > 0 && (r.onProgress = (A) => this.emit(Rn.DOWNLOAD_PROGRESS, A));
  ...
  async differentialDownloadInstaller(e, n, r, i, s) {
    try {
      ...
      const l = async (y) => {
        ...
        try {
          return JSON.parse((0, za.gunzipSync)(_).toString());
        } catch (E) {
      ...
      this.listenerCount(Rn.DOWNLOAD_PROGRESS) > 0 && (f.onProgress = (y) => this.emit(Rn.DOWNLOAD_PROGRESS, y));
      const c = async (y, _) => {
        const E = ct.join(_, "current.blockmap");
        await (0, lt.outputFile)(E, (0, za.gzipSync)(JSON.stringify(y)));
      }, u = async (y) => {
        const _ = ct.join(y, "current.blockmap");
        try {
          if (await (0, lt.pathExists)(_))
            return JSON.parse((0, za.gunzipSync)(await (0, lt.readFile)(_)).toString());
        } catch (E) {
...
class RC extends TC.AppUpdater {
  ...
  quitAndInstall(e = !1, n = !1) {
    this._logger.info("Install on explicit quitAndInstall"), this.install(e, e ? n : this.autoRunAppAfterInstall) ? setImmediate(() => {
      gn.autoUpdater.emit("before-quit-for-update"), this.app.quit();
...
async function PC(t) {
  const e = await (0, In.open)(t, "r");
  try {
    const n = (await (0, In.fstat)(e)).size, r = Buffer.allocUnsafe(4);
    await (0, In.read)(e, r, 0, r.length, n - r.length);
    const i = Buffer.allocUnsafe(r.readUInt32BE(0));
    return await (0, In.read)(e, i, 0, i.length, n - r.length - i.length), await (0, In.close)(e), qh(i);
  } catch (n) {
    throw await (0, In.close)(e), n;
  }
}
Object.defineProperty(Mr, "__esModule", { value: !0 });
Mr.AppImageUpdater = void 0;
const ju = Ae, Hu = Rs, xC = Kt, NC = ye, ur = he, DC = vn, FC = ai, LC = we, qu = Jt;
class kC extends DC.BaseUpdater {
  ...
  doInstall(e) {
    ...
    (0, NC.unlinkSync)(n);
    let r;
    const i = ur.basename(n), s = this.installerPath;
    if (s == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    ur.basename(s) === i || !/\d+\.\d+\.\d+/.test(i) ? r = n : r = ur.join(ur.dirname(n), ur.basename(s)), (0, Hu.execFileSync)("mv", ["-f", s, r]), r !== n && this.emit("appimage-filename-updated", r);
    const a = {
      ...process.env,
...
const zu = Ae, Ya = Kt, VC = ye, Yu = he, zC = Lg, YC = Gt, XC = we, Xu = Rs, Ku = yn;
class KC extends YC.AppUpdater {
  constructor(e, n) {
    super(e, n), this.nativeUpdater = gn.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (r) => {
  ...
  async doDownloadUpdate(e) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: e,
      task: async (u, h) => {
        const p = Yu.join(this.downloadedUpdateHelper.cacheDir, c), y = () => (0, Ya.pathExistsSync)(p) ? !e.disableDifferentialDownload : (r.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let _ = !0;
        ...
        if (!e.disableDifferentialDownload)
          try {
            ...
            await (0, Ya.copyFile)(u.downloadedFile, h);
          } catch (h) {
  ...
  async updateDownloaded(e, n) {
    var r;
    const i = n.downloadedFile, s = (r = e.info.size) !== null && r !== void 0 ? r : (await (0, Ya.stat)(i)).size, a = this._logger, o = `fileToProxy=${e.url.href}`;
        ...
        if (c.Status === 0) {
          try {
            ...
            if (n.info(`LiteralPath: ${y}. Update Path: ${_}`), y !== _) {
              Xa(n, new Error(`LiteralPath of ${y} is different than ${_}`), l, i), r(null);
              return;
            }
          } catch (y) {
...
const Li = Ae, Zu = he, tT = vn, nT = ai, ef = Jt, rT = we, iT = Kt, sT = _l, tf = Xt;
class aT extends tT.BaseUpdater {
  ...
  doInstall(e) {
    ...
    return e.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), s(), !0) : (this.spawnLog(n, r).catch((a) => {
      const o = a.code;
      this._logger.info(`Cannot run installer: error code: ${o}, error message: "${a.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), o === "UNKNOWN" || o === "EACCES" ? s() : o === "ENOENT" ? gn.shell.openPath(n).catch((l) => this.dispatchError(l)) : this.dispatchError(a);
    }), !0);
  }
...
class Ne extends G {
  ...
  static generate(e, n, r, i) {
    if (!e || !i)
      return new Js({ message: r, cause: bo(n) });
...
}, oi = (t) => new Promise((e) => setTimeout(e, t)), Nn = "6.25.0", hT = () => (
  // @ts-ignore
...
let Ao = (t, e) => (Ao = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty), Ao(t, e));
const yt = /* @__PURE__ */ (() => {
  const t = [];
  for (let e = 0; e < 256; ++e)
    t.push("%" + ((e < 16 ? "0" : "") + e.toString(16)).toUpperCase());
  return t;
})(), Ja = 1024, bT = (t, e, n, r, i) => {
  if (t.length === 0)
    return t;
  let s = t;
  ...
  let a = "";
  for (let o = 0; o < s.length; o += Ja) {
    const l = s.length >= Ja ? s.slice(o, o + Ja) : s, f = [];
...
Qs.NEWLINE_CHARS = /* @__PURE__ */ new Set([`
`, "\r"]);
Qs.NEWLINE_REGEXP = /\r\n|[\n\r]/g;
function IT(t, e) {
...
const ys = {
  ...
  if (t) {
    if (uT(ys, t))
      return t;
    $e(n).warn(`${e} was set to ${JSON.stringify(t)}, expected one of ${JSON.stringify(Object.keys(ys))}`);
  }
};
function mr() {
}
function ki(t, e, n) {
  return !e || ys[t] > ys[n] ? mr : e[t].bind(e);
}
const $T = {
  error: mr,
  warn: mr,
...
const on = (t) => (t.options && (t.options = { ...t.options }, delete t.options.headers), t.headers && (t.headers = Object.fromEntries((t.headers instanceof Headers ? [...t.headers] : Object.entries(t.headers)).map(([e, n]) => [
  e,
...
class vt {
  constructor(e, n, r) {
    this.iterator = e, fr.set(this, void 0), this.controller = n, z(this, fr, r);
  }
  ...
  tee() {
    ...
    return [
      new vt(() => i(e), this.controller, S(this, fr, "f")),
      new vt(() => i(n), this.controller, S(this, fr, "f"))
    ];
  }
  /**
...
async function* PT(t, e) {
  ...
  const n = new NT(), r = new Qs(), i = ap(t.body);
...
async function dp(t, e) {
  ...
  return $e(t).debug(`[${r}] response parsed`, on({
...
class Zs extends Promise {
  ...
  _thenUnwrap(e) {
    return new Zs(S(this, gr, "f"), this.responsePromise, async (n, r) => hp(e(await this.parseResponse(n, r), r), r.response));
  }
  /**
...
const vl = (t) => t != null && typeof t == "object" && typeof t[Symbol.asyncIterator] == "function", Wr = async (t, e) => So(t.body) ? { ...t, body: await mp(t.body, e) } : t, Yn = async (t, e) => ({ ...t, body: await mp(t.body, e) }), mf = /* @__PURE__ */ new WeakMap();
function LT(t) {
...
const mp = async (t, e) => {
  ...
  return await Promise.all(Object.entries(t || {}).map(([r, i]) => Co(n, r, i))), n;
}, gp = (t) => t instanceof Blob && "name" in t, kT = (t) => typeof t == "object" && t !== null && (t instanceof Response || vl(t) || gp(t)), So = (t) => {
  if (kT(t))
    return !0;
  if (Array.isArray(t))
    return t.some(So);
  ...
  if (n !== void 0) {
    ...
    if (typeof n == "string" || typeof n == "number" || typeof n == "boolean")
      ...
      await Promise.all(n.map((r) => Co(t, e + "[]", r)));
    else if (typeof n == "object")
      await Promise.all(Object.entries(n).map(([r, i]) => Co(t, `${e}[${r}]`, i)));
    else
...
async function BT(t, e, n) {
  ...
  if (MT(t)) {
    ...
    return e || (e = new URL(t.url).pathname.split(/[\\/]/).pop()), Rr(await To(i), e, n);
  }
  const r = await To(t);
...
function WT(t, e) {
  ...
  const n = (r = t.tools) == null ? void 0 : r.find((i) => {
    var s;
    return Es(i) && ((s = i.function) == null ? void 0 : s.name) === e.function.name;
  });
  return {
    ...e,
    function: {
...
function VT(t, e) {
  ...
  return Es(n) && (li(n) || (n == null ? void 0 : n.function.strict) || !1);
}
function Ep(t) {
  var e;
...
const vs = (t) => (t == null ? void 0 : t.role) === "assistant", bp = (t) => (t == null ? void 0 : t.role) === "tool";
var Ro, Xi, Ki, _r, yr, Ji, wr, It, Er, bs, As, Dn, Ap;
class Sl {
  constructor() {
    Ro.add(this), this.controller = new AbortController(), Xi.set(this, void 0), Ki.set(this, () => {
    }), _r.set(this, () => {
    }), yr.set(this, void 0), Ji.set(this, () => {
    }), wr.set(this, () => {
    }), It.set(this, {}), Er.set(this, !1), bs.set(this, !1), As.set(this, !1), Dn.set(this, !1), z(this, Xi, new Promise((e, n) => {
   ...
   */
  on(e, n) {
    return (S(this, It, "f")[e] || (S(this, It, "f")[e] = [])).push({ listener: n }), this;
  }
  /**
   ...
   */
  once(e, n) {
    return (S(this, It, "f")[e] || (S(this, It, "f")[e] = [])).push({ listener: n, once: !0 }), this;
  }
  /**
  ...
  emitted(e) {
    return new Promise((n, r) => {
      z(this, Dn, !0), e !== "error" && this.once("error", r), this.once(e, n);
    });
  }
  async done() {
    z(this, Dn, !0), await S(this, yr, "f");
  }
  _emit(e, ...n) {
    if (S(this, Er, "f"))
      return;
    ...
    const r = S(this, It, "f")[e];
    if (r && (S(this, It, "f")[e] = r.filter((i) => !i.once), r.forEach(({ listener: i }) => i(...n))), e === "abort") {
      const i = n[0];
      !S(this, Dn, "f") && !(r != null && r.length) && Promise.reject(i), S(this, _r, "f").call(this, i), S(this, wr, "f").call(this, i), this._emit("end");
      return;
    }
    if (e === "error") {
      const i = n[0];
...
Xi = /* @__PURE__ */ new WeakMap(), Ki = /* @__PURE__ */ new WeakMap(), _r = /* @__PURE__ */ new WeakMap(), yr = /* @__PURE__ */ new WeakMap(), Ji = /* @__PURE__ */ new WeakMap(), wr = /* @__PURE__ */ new WeakMap(), It = /* @__PURE__ */ new WeakMap(), Er = /* @__PURE__ */ new WeakMap(), bs = /* @__PURE__ */ new WeakMap(), As = /* @__PURE__ */ new WeakMap(), Dn = /* @__PURE__ */ new WeakMap(), Ro = /* @__PURE__ */ new WeakSet(), Ap = function(e) {
  if (z(this, bs, !0), e instanceof Error && e.name === "AbortError" && (e = new st()), e instanceof st)
    return z(this, As, !0), this._emit("abort", e);
  if (e instanceof G)
...
class Tp extends Sl {
   ...
   */
  async finalMessage() {
    return await this.done(), S(this, je, "m", Ss).call(this);
  }
  /**
  ...
  async totalUsage() {
    return await this.done(), S(this, je, "m", Po).call(this);
  }
  allChatCompletions() {
  ...
  _emitFinal() {
    ...
    const n = S(this, je, "m", Ss).call(this);
    n && this._emit("finalMessage", n);
    const r = S(this, je, "m", Io).call(this);
    r && this._emit("finalContent", r);
    const i = S(this, je, "m", Oo).call(this);
    i && this._emit("finalFunctionToolCall", i);
    const s = S(this, je, "m", $o).call(this);
    s != null && this._emit("finalFunctionToolCallResult", s), this._chatCompletions.some((a) => a.usage) && this._emit("totalUsage", S(this, je, "m", Po).call(this));
  }
...
je = /* @__PURE__ */ new WeakSet(), Io = function() {
  return S(this, je, "m", Ss).call(this).content ?? null;
}, Ss = function() {
  ...
  for (let r = this.messages.length - 1; r >= 0; r--) {
    ...
    if (vs(i) && ((e = i == null ? void 0 : i.tool_calls) != null && e.length))
...
class Cl extends Tp {
  ...
  _addMessage(e, n = !0) {
    super._addMessage(e, n), vs(e) && e.content && this._emit("content", e.content);
  }
}
...
var ve, Tt, On, kt, Za, Mi, eo, to, no, Bi, ro, yf;
class Vr extends Tp {
  constructor(e) {
    super(), ve.add(this), Tt.set(this, void 0), On.set(this, void 0), kt.set(this, void 0), z(this, Tt, e), z(this, On, []);
  }
  ...
  async _createChatCompletion(e, n, r) {
    ...
    const i = r == null ? void 0 : r.signal;
    i && (i.aborted && this.controller.abort(), i.addEventListener("abort", () => this.controller.abort())), S(this, ve, "m", Za).call(this);
    const s = await e.chat.completions.create({ ...n, stream: !0 }, { ...r, signal: this.controller.signal });
    this._connected();
    for await (const o of s)
      S(this, ve, "m", eo).call(this, o);
  ...
  async _fromReadableStream(e, n) {
    ...
    r && (r.aborted && this.controller.abort(), r.addEventListener("abort", () => this.controller.abort())), S(this, ve, "m", Za).call(this), this._connected();
    const i = vt.fromReadableStream(e, this.controller);
    let s;
    for await (const o of i)
      s && s !== o.id && this._addChatCompletion(S(this, ve, "m", Bi).call(this)), S(this, ve, "m", eo).call(this, o), s = o.id;
    if ((a = i.controller.signal) != null && a.aborted)
      throw new st();
    return this._addChatCompletion(S(this, ve, "m", Bi).call(this));
  }
  [(Tt = /* @__PURE__ */ new WeakMap(), On = /* @__PURE__ */ new WeakMap(), kt = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakSet(), Za = function() {
    this.ended || z(this, kt, void 0);
  }, Mi = function(n) {
    let r = S(this, On, "f")[n.index];
    return r || (r = {
      content_done: !1,
      refusal_done: !1,
    ...
    for (const O of n.choices) {
      ...
      T.finish_reason && (S(this, ve, "m", no).call(this, T), K.current_tool_call_index != null && S(this, ve, "m", to).call(this, T, K.current_tool_call_index));
      for (const Y of O.delta.tool_calls ?? [])
        K.current_tool_call_index !== Y.index && (S(this, ve, "m", no).call(this, T), K.current_tool_call_index != null && S(this, ve, "m", to).call(this, T, K.current_tool_call_index)), K.current_tool_call_index = Y.index;
      for (const Y of O.delta.tool_calls ?? []) {
    ...
    if (s.type === "function") {
      const f = (l = (o = S(this, Tt, "f")) == null ? void 0 : o.tools) == null ? void 0 : l.find((c) => Es(c) && c.function.name === s.function.name);
    ...
    if (n.message.content && !r.content_done) {
      r.content_done = !0;
      const a = S(this, ve, "m", ro).call(this);
    ...
    return z(this, kt, void 0), z(this, On, []), tR(n, S(this, Tt, "f"));
  }, ro = function() {
    var r;
    ...
    let o = S(this, kt, "f");
    const { choices: l, ...f } = n;
    o ? Object.assign(o, f) : o = z(this, kt, {
      ...f,
      choices: []
    });
...
let Tl = class extends H {
  ...
  runTools(e, n) {
    return e.stream ? Cs.runTools(this._client, e, n) : Cl.runTools(this._client, e, n);
  }
  /**
...
class Hp extends H {
  create(e, n) {
    return this._client.post("/audio/transcriptions", Yn({
      body: e,
      ...n,
      stream: e.stream ?? !1,
...
class qp extends H {
  create(e, n) {
    return this._client.post("/audio/translations", Yn({ body: e, ...n, __metadata: { model: e.model } }, this._client));
  }
}
class ci extends H {
  constructor() {
...
let Xp = class extends H {
   ...
   */
  list(e = {}, n) {
    return this._client.getAPIList("/chatkit/threads", ws, {
      query: e,
      ...n,
      headers: M([{ "OpenAI-Beta": "chatkit_beta=v1" }, n == null ? void 0 : n.headers])
    });
   ...
   */
  listItems(e, n = {}, r) {
    return this._client.getAPIList(x`/chatkit/threads/${e}/items`, ws, { query: n, ...r, headers: M([{ "OpenAI-Beta": "chatkit_beta=v1" }, r == null ? void 0 : r.headers]) });
  }
};
class na extends H {
  constructor() {
...
var Pe, dn, xo, Et, Qi, ut, hn, jn, cn, Ts, nt, Zi, es, Ir, vr, br, wf, Ef, vf, bf, Af, Sf, Cf;
class Or extends Sl {
  constructor() {
    super(...arguments), Pe.add(this), xo.set(this, []), Et.set(this, {}), Qi.set(this, {}), ut.set(this, void 0), hn.set(this, void 0), jn.set(this, void 0), cn.set(this, void 0), Ts.set(this, void 0), nt.set(this, void 0), Zi.set(this, void 0), es.set(this, void 0), Ir.set(this, void 0);
  }
  [(xo = /* @__PURE__ */ new WeakMap(), Et = /* @__PURE__ */ new WeakMap(), Qi = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakMap(), hn = /* @__PURE__ */ new WeakMap(), jn = /* @__PURE__ */ new WeakMap(), cn = /* @__PURE__ */ new WeakMap(), Ts = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new WeakMap(), Zi = /* @__PURE__ */ new WeakMap(), es = /* @__PURE__ */ new WeakMap(), Ir = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakSet(), Symbol.asyncIterator)]() {
    const e = [], n = [];
    let r = !1;
  ...
  async finalRun() {
    if (await this.done(), !S(this, hn, "f"))
...
dn = Or, vr = function(e) {
    ...
    case "thread.message.delta":
      if (this._emit("messageDelta", e.data.delta, n), e.data.delta.content)
        for (const i of e.data.delta.content) {
          ...
          if (i.index != S(this, jn, "f")) {
            if (S(this, cn, "f"))
              switch (S(this, cn, "f").type) {
                case "text":
                  this._emit("textDone", S(this, cn, "f").text, S(this, ut, "f"));
                  break;
                case "image_file":
                  this._emit("imageFileDone", S(this, cn, "f").image_file, S(this, ut, "f"));
                  break;
              }
            z(this, jn, i.index);
          }
          z(this, cn, n.content[i.index]);
        }
      break;
    case "thread.message.completed":
    case "thread.message.incomplete":
      if (S(this, jn, "f") !== void 0) {
        const i = e.data.content[S(this, jn, "f")];
        if (i)
          switch (i.type) {
            case "image_file":
    ...
    case "thread.run.step.delta":
      ...
      if (r.step_details && r.step_details.type == "tool_calls" && r.step_details.tool_calls && n.step_details.type == "tool_calls")
        for (const s of r.step_details.tool_calls)
          s.index == S(this, Ts, "f") ? this._emit("toolCallDelta", s, n.step_details.tool_calls[s.index]) : (S(this, nt, "f") && this._emit("toolCallDone", S(this, nt, "f")), z(this, Ts, s.index), z(this, nt, n.step_details.tool_calls[s.index]), S(this, nt, "f") && this._emit("toolCallCreated", S(this, nt, "f")));
  ...
  S(this, xo, "f").push(e), this._emit("event", e);
}, bf = function(e) {
  switch (e.event) {
    case "thread.run.step.created":
    ...
    case "thread.run.step.delta":
      ...
      let r = e.data;
      if (r.delta) {
        const i = dn.accumulateDelta(n, r.delta);
  ...
  switch (z(this, es, e.data), e.event) {
    ...
    case "thread.run.expired":
    case "thread.run.incomplete":
      z(this, hn, e.data), S(this, nt, "f") && (this._emit("toolCallDone", S(this, nt, "f")), z(this, nt, void 0));
      break;
  }
};
...
class er extends H {
  constructor() {
    super(...arguments), this.realtime = new ta(this._client), this.chatkit = new na(this._client), this.assistants = new Wp(this._client), this.threads = new ra(this._client);
  }
}
er.Realtime = ta;
er.ChatKit = na;
...
class em extends H {
   ...
   */
  list(e, n = {}, r) {
    return this._client.getAPIList(x`/conversations/${e}/items`, ws, { query: n, ...r });
  }
  /**
...
let rm = class extends H {
   ...
   */
  create(e, n) {
    return this._client.post("/files", Yn({ body: e, ...n }, this._client));
  }
  /**
...
class am extends H {
   ...
   */
  create(e, n, r) {
    return this._client.getAPIList(x`/fine_tuning/checkpoints/${e}/permissions`, ea, { body: n, method: "post", ...r });
  }
  /**
...
class cm extends H {
   ...
   */
  createVariation(e, n) {
    return this._client.post("/images/variations", Yn({ body: e, ...n }, this._client));
  }
  edit(e, n) {
    return this._client.post("/images/edits", Yn({ body: e, ...n, stream: e.stream ?? !1 }, this._client));
  }
  generate(e, n) {
...
class um extends H {
   ...
   */
  list(e) {
    return this._client.getAPIList("/models", ea, e);
  }
  /**
...
function pm(t, e) {
  ...
  return Object.getOwnPropertyDescriptor(t, "output_text") || No(r), Object.defineProperty(r, "output_parsed", {
    enumerable: !0,
    get() {
...
var Pn, Hi, Ut, qi, Tf, Rf, If, Of;
class Ul extends Sl {
  constructor(e) {
    super(), Pn.add(this), Hi.set(this, void 0), Ut.set(this, void 0), qi.set(this, void 0), z(this, Hi, e);
  }
  ...
  async _createOrRetrieveResponse(e, n, r) {
    var o;
    const i = r == null ? void 0 : r.signal;
    i && (i.aborted && this.controller.abort(), i.addEventListener("abort", () => this.controller.abort())), S(this, Pn, "m", Tf).call(this);
    let s, a = null;
    ...
    for await (const l of s)
      S(this, Pn, "m", Rf).call(this, l, a);
    if ((o = s.controller.signal) != null && o.aborted)
      throw new st();
    return S(this, Pn, "m", If).call(this);
  }
  [(Hi = /* @__PURE__ */ new WeakMap(), Ut = /* @__PURE__ */ new WeakMap(), qi = /* @__PURE__ */ new WeakMap(), Pn = /* @__PURE__ */ new WeakSet(), Tf = function() {
    this.ended || z(this, Ut, void 0);
  }, Rf = function(n, r) {
    if (this.ended)
      return;
    const i = (a, o) => {
      (r == null || o.sequence_number > r) && this._emit(a, o);
    }, s = S(this, Pn, "m", Of).call(this, n);
    ...
    if (!r) {
      ...
      return r = z(this, Ut, n.response), r;
    }
    switch (n.type) {
...
class sa extends H {
  ...
  create(e, n) {
    return this._client.post("/responses", { body: e, ...n, stream: e.stream ?? !1 })._thenUnwrap((r) => ("object" in r && r.object === "response" && No(r), r));
  }
  retrieve(e, n = {}, r) {
    ...
    })._thenUnwrap((i) => ("object" in i && i.object === "response" && No(i), i));
  }
  /**
...
class wm extends H {
   ...
   */
  create(e, n, r) {
    return this._client.post(x`/uploads/${e}/parts`, Yn({ body: n, ...r }, this._client));
  }
}
class Bl extends H {
  constructor() {
...
class vm extends H {
  ...
  content(e, n, r) {
    const { vector_store_id: i } = n;
    return this._client.getAPIList(x`/vector_stores/${i}/files/${e}/content`, ea, { ...r, headers: M([{ "OpenAI-Beta": "assistants=v2" }, r == null ? void 0 : r.headers]) });
  }
}
class oa extends H {
  constructor() {
   ...
   */
  search(e, n, r) {
    return this._client.getAPIList(x`/vector_stores/${e}/search`, ea, {
      body: n,
      method: "post",
      ...r,
      headers: M([{ "OpenAI-Beta": "assistants=v2" }, r == null ? void 0 : r.headers])
...
class bm extends H {
   ...
   */
  list(e = {}, n) {
    return this._client.getAPIList("/videos", ws, { query: e, ...n });
  }
  /**
...
class Sm extends H {
  ...
  async verifySignature(e, n, r = this._client.webhookSecret, i = 300) {
    ...
    S(this, Fn, "m", Am).call(this, r);
    const s = M([n]).values, a = S(this, Fn, "m", ts).call(this, s, "webhook-signature"), o = S(this, Fn, "m", ts).call(this, s, "webhook-timestamp"), l = S(this, Fn, "m", ts).call(this, s, "webhook-id"), f = parseInt(o, 10);
    if (isNaN(f))
...
Fn = /* @__PURE__ */ new WeakSet(), Am = function(e) {
...
class J {
   ...
   */
  constructor({ baseURL: e = $n("OPENAI_BASE_URL"), apiKey: n = $n("OPENAI_API_KEY"), organization: r = $n("OPENAI_ORG_ID") ?? null, project: i = $n("OPENAI_PROJECT_ID") ?? null, webhookSecret: s = $n("OPENAI_WEBHOOK_SECRET") ?? null, ...a } = {}) {
    if (Do.add(this), ns.set(this, void 0), this.completions = new Qp(this), this.chat = new Rl(this), this.embeddings = new tm(this), this.files = new rm(this), this.images = new cm(this), this.audio = new ci(this), this.moderations = new fm(this), this.models = new um(this), this.fineTuning = new tr(this), this.graders = new kl(this), this.vectorStores = new oa(this), this.webhooks = new Sm(this), this.beta = new er(this), this.batches = new Gp(this), this.uploads = new Bl(this), this.responses = new sa(this), this.realtime = new ia(this), this.conversations = new Pl(this), this.evals = new Nl(this), this.containers = new $l(this), this.skills = new aa(this), this.videos = new bm(this), n === void 0)
...
`);
    ...
    const l = "warn";
    this.logLevel = l, this.logLevel = hf(o.logLevel, "ClientOptions.logLevel", this) ?? hf($n("OPENAI_LOG"), "process.env['OPENAI_LOG']", this) ?? l, this.fetchOptions = o.fetchOptions, this.maxRetries = o.maxRetries ?? 2, this.fetch = o.fetch ?? yT(), z(this, ns, ET), this._options = o, this.apiKey = typeof n == "string" ? n : "Missing Key", this.organization = r, this.project = i, this.webhookSecret = s;
  }
  /**
  ...
  buildURL(e, n, r) {
    const i = !S(this, Do, "m", Cm).call(this) && r || this.baseURL, s = lT(e) ? new URL(e) : new URL(i + (i.endsWith("/") && e.startsWith("/") ? e.slice(1) : e)), a = this.defaultQuery();
  ...
  request(e, n = null) {
    return new Zs(this, this.makeRequest(e, n, void 0));
  }
  async makeRequest(e, n, r) {
    ...
    if ($e(this).debug(`[${f}] sending request`, on({
      ...
      throw new st();
    const h = new AbortController(), p = await this.fetchWithTimeout(o, a, l, h).catch(bo), y = Date.now();
    if (p instanceof globalThis.Error) {
      const O = `retrying, ${n} attempts remaining`;
      if ((A = i.signal) != null && A.aborted)
        throw new st();
      const T = vo(p) || /timed? ?out/i.test(String(p) + ("cause" in p ? String(p.cause) : ""));
      if (n)
        return $e(this).info(`[${f}] connection ${T ? "timed out" : "failed"} - ${O}`), $e(this).debug(`[${f}] connection ${T ? "timed out" : "failed"} (${O})`, on({
          retryOfRequestLogID: r,
          url: o,
          durationMs: y - u,
          message: p.message
        })), this.retryRequest(i, n, r ?? f);
      throw $e(this).info(`[${f}] connection ${T ? "timed out" : "failed"} - error; no more retries left`), $e(this).debug(`[${f}] connection ${T ? "timed out" : "failed"} (error; no more retries left)`, on({
        retryOfRequestLogID: r,
        url: o,
        durationMs: y - u,
        message: p.message
      })), T ? new yl() : new Js({ cause: p });
    }
    ...
    if (!p.ok) {
      ...
      if (n && O) {
        ...
        return await wT(p.body), $e(this).info(`${E} - ${w}`), $e(this).debug(`[${f}] response error (${w})`, on({
          retryOfRequestLogID: r,
          url: p.url,
          status: p.status,
          headers: p.headers,
      ...
      $e(this).info(`${E} - ${T}`);
      const K = await p.text().catch((w) => bo(w).message), Y = dT(K), U = Y ? void 0 : K;
      throw $e(this).debug(`[${f}] response error (${T})`, on({
        retryOfRequestLogID: r,
        url: p.url,
        status: p.status,
        headers: p.headers,
    ...
    return $e(this).info(E), $e(this).debug(`[${f}] response start`, on({
      retryOfRequestLogID: r,
      url: p.url,
      status: p.status,
      headers: p.headers,
...
jl = J, ns = /* @__PURE__ */ new WeakMap(), Do = /* @__PURE__ */ new WeakSet(), Cm = function() {
...
const Fo = process.env.VITE_DEV_SERVER_URL, zR = de.join(process.env.APP_ROOT, "dist-electron"), Im = de.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = Fo ? de.join(process.env.APP_ROOT, "public") : Im;
let oe;
const Pf = {
  zh: {
    edit: "编辑",
...
function $m() {
  ...
  }), Fo ? oe.loadURL(Fo) : oe.loadFile(de.join(Im, "index.html"));
}
const pR = new J({
...
Qe.whenReady().then(() => {
  Ng.handle("local-file", (t) => {
  ...
  }), Om(), $m(), Qe.isPackaged && (is.showMessageBox({
    type: "info",
    title: "测试",
    message: "更新检查代码已执行！",
    buttons: ["确定"]
    ...
    console.log("正在检查更新...");
  }), Rt.autoUpdater.on("update-available", (t) => {
    console.log("发现新版本:", t.version);
  }), Rt.autoUpdater.on("update-not-available", (t) => {
    console.log("当前已是最新版本。", t);
  }), Rt.autoUpdater.on("download-progress", (t) => {
    let e = "下载速度: " + (t.bytesPerSecond / 1024 / 1024).toFixed(2) + " MB/s";
    e = e + " - 已下载 " + t.percent.toFixed(2) + "%", console.log(e);
  }), Rt.autoUpdater.on("update-downloaded", (t) => {
    console.log("新版本已下载完成:", t.version), is.showMessageBox({
      type: "info",
      title: "更新可用",
      message: `新版本 ${t.version} 已下载完成，将立即重启安装。`,
      buttons: ["确定"]
    }).then(() => {
      Rt.autoUpdater.quitAndInstall();
    });
  }), Rt.autoUpdater.on("error", (t) => {
    console.error("自动更新出错:", t);
  }), Rt.autoUpdater.checkForUpdatesAndNotify());
});
const zr = /* @__PURE__ */ new Map();
Pt.on("start-chat", async (t, e) => {
  const n = Lo.fromWebContents(t.sender);
...
Pt.handle("get-system-info", () => ({
  platform: process.platform,
  arch: process.arch
}));
Pt.handle("get-active-chat-ids", () => Array.from(zr.keys()));
Pt.on("update-menu-locale", (t, e) => {
  Om(e);
});
const Yr = de.join(Qe.getPath("userData"), "config.json");
Pt.handle("get-config", () => {
  if (ye.existsSync(Yr))
    try {
...
Pt.handle("select-image", async () => {
  const { canceled: t, filePaths: e } = await is.showOpenDialog({
    properties: ["openFile"],
    filters: [
  ...
  const i = de.extname(n), a = `${yn.createHash("md5").update(n + Date.now()).digest("hex")}${i}`, o = de.join(r, a);
  return ye.copyFileSync(n, o), {
    path: `local-file://${a}`,
    fileName: a
  };
});
Pt.handle("select-file", async () => {
  const { canceled: t, filePaths: e } = await is.showOpenDialog({
    properties: ["openFile"],
    filters: [
  ...
  const n = e[0], r = de.join(Qe.getPath("userData"), "uploads");
  ye.existsSync(r) || ye.mkdirSync(r, { recursive: !0 });
  const i = de.extname(n), s = de.basename(n), o = `${yn.createHash("md5").update(n + Date.now()).digest("hex")}${i}`, l = de.join(r, o);
  ye.copyFileSync(n, l);
